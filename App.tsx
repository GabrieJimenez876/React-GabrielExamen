...
export default function App() {
	...
	const datos: FilaTarea[] = [
		...
		{
			empleado: "Nattali Rize",
			idTarea: "TID0002498",
			tarea: "Desarrollo Tema RWD",
			inicio: "28/08/2018",
			fin: "05/09/2018",
			conteo: 9,
			estado: "Completado",
	...
	const filtros = (
		<div className="flex items-center gap-2">
			<span className="px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-xs font-medium">Estado : Completado</span>
		</div>
	);
